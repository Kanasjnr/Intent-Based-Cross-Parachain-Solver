...
const emaBars = [40, 45, 42, 48, 52, 50, 55, 60, 58, 65, 62, 58, 60, 64, 70, 75, 72, 68, 70, 74];
    ...
    <div className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
            <div className="p-3.5 bg-black/30 rounded-xl border border-white/5">
                ...
                <p className="text-lg font-mono font-bold text-white">$7.441</p>
            ...
            <div className="p-3.5 bg-black/30 rounded-xl border border-white/5">
                ...
                <p className="text-lg font-mono font-bold text-teal-400">$6.696</p>
