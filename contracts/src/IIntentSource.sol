...
interface IIntentSource {
     ...
     */
    function lockIntent(Intent calldata intent, bytes calldata signature) external;
     ...
     */
    function settleIntent(Intent calldata intent, bytes calldata proof) external;
